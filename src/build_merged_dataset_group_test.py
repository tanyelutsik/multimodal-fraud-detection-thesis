...
print("build_merged_dataset_group_test.py started")
...
def load_image_splits():
    train_path = PROCESSED_DIR / "image_train_group_test.csv"
    val_path = PROCESSED_DIR / "image_val_group_test.csv"
    test_path = PROCESSED_DIR / "image_test_group_test.csv"
...
if __name__ == "__main__":
    ...
    save_split(mm_train, "mm_train_group_test.csv")
    save_split(mm_val, "mm_val_group_test.csv")
    save_split(mm_test, "mm_test_group_test.csv")
    save_split(mm_full, "mm_full_group_test.csv")

    print_info("MM TRAIN GROUP TEST", mm_train)
    print_info("MM VAL GROUP TEST", mm_val)
    print_info("MM TEST GROUP TEST", mm_test)
    print_info("MM FULL GROUP TEST", mm_full)
